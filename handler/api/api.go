...
import (
	...
	"github.com/mlclmj/drone/handler/api/acl"
	"github.com/mlclmj/drone/handler/api/auth"
	"github.com/mlclmj/drone/handler/api/badge"
	globalbuilds "github.com/mlclmj/drone/handler/api/builds"
	"github.com/mlclmj/drone/handler/api/ccmenu"
	"github.com/mlclmj/drone/handler/api/events"
	"github.com/mlclmj/drone/handler/api/queue"
	"github.com/mlclmj/drone/handler/api/repos"
	"github.com/mlclmj/drone/handler/api/repos/builds"
	"github.com/mlclmj/drone/handler/api/repos/builds/branches"
	"github.com/mlclmj/drone/handler/api/repos/builds/deploys"
	"github.com/mlclmj/drone/handler/api/repos/builds/logs"
	"github.com/mlclmj/drone/handler/api/repos/builds/pulls"
	"github.com/mlclmj/drone/handler/api/repos/builds/stages"
	"github.com/mlclmj/drone/handler/api/repos/collabs"
	"github.com/mlclmj/drone/handler/api/repos/crons"
	"github.com/mlclmj/drone/handler/api/repos/encrypt"
	"github.com/mlclmj/drone/handler/api/repos/secrets"
	"github.com/mlclmj/drone/handler/api/repos/sign"
	globalsecrets "github.com/mlclmj/drone/handler/api/secrets"
	"github.com/mlclmj/drone/handler/api/system"
	"github.com/mlclmj/drone/handler/api/user"
	"github.com/mlclmj/drone/handler/api/user/remote"
	"github.com/mlclmj/drone/handler/api/users"
